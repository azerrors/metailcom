...
function Favorites() {
  ...
  return (
    <div className="md:mx-72 mt-10">
      <h3 className="md:text-3xl tracking-wider font-medium dark:text-secondary text-stone-900 border-b-2 p-2 border-tertiary rounded-md">
        Your Favorites
      </h3>
      {favorites.length === 0 && (
        <div className="flex justify-center items-center mt-20">
          <TbMoodHappy className="text-tertiary_light  text-5xl" />
        </div>
      )}
